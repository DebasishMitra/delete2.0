  ...
  function clearAllInputs() {
      ...
      const custom = document.getElementById('custom-dork-input');
      ...
      if (queryText) queryText.innerText = 'waiting for input...';
      
      if (typeof showToast === 'function') showToast('All inputs cleared', 'info');
  }
